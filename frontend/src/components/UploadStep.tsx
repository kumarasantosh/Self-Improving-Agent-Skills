...
const EXAMPLE_SKILLS = [
  {
    name: "Code Auditor",
    description: "Evaluates source code for security vulnerabilities, efficiency, and architectural idioms",
    path: "code-auditor",
  },
  {
    name: "Copy Assistant",
    description: "Generates high-converting SaaS value propositions, hooks, and direct marketing copy",
    path: "copy-assistant",
  },
];
